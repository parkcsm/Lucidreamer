...
public class MainActivity extends AppCompatActivity {
    ...
    Button btn_app_explanarion, btn_app_characteristic, btn_music;
    Button what_is_lucid_dream, lucid_dream_wording, naver_lucid_dream_cafe, daum_lucid_dream_cafe;
    Button btn_register, btn_login;
    ScrollView app_explanation, app_characteristic, app_etc;

    /**
     * 여기아래로 음악관련 부분
     */
    String streaming_time;
    seekbar_time_thread task;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        app_characteristic = findViewById(R.id.app_characteristic);
        app_etc = findViewById(R.id.app_etc);

        btn_app_explanarion = findViewById(R.id.btn_app_explanation);
        btn_app_characteristic = findViewById(R.id.btn_app_characteristic);
        btn_music = findViewById(R.id.btn_music);

        btn_app_explanarion.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                app_explanation.setVisibility(view.VISIBLE);
                app_characteristic.setVisibility(view.INVISIBLE);
                app_etc.setVisibility(view.INVISIBLE);
            }
        });

        btn_app_characteristic.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                app_explanation.setVisibility(view.INVISIBLE);
                app_characteristic.setVisibility(view.VISIBLE);
                app_etc.setVisibility(view.INVISIBLE);
            }
        });
        ...
        btn_music.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                app_explanation.setVisibility(view.INVISIBLE);
                app_characteristic.setVisibility(view.INVISIBLE);
                app_etc.setVisibility(view.VISIBLE);
            }
        });

        what_is_lucid_dream = findViewById(R.id.what_is_lucid_dream);
        lucid_dream_wording = findViewById(R.id.lucid_dream_wording);

        what_is_lucid_dream.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myintent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://namu.wiki/w/%EC%9E%90%EA%B0%81%EB%AA%BD"));
                startActivity(myintent);
            }
        });


        lucid_dream_wording.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myintent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://m.blog.naver.com/PostView.nhn?blogId=fntlem0815&logNo=220883000307&proxyReferer=https%3A%2F%2Fwww.google.co.kr%2F"));
                startActivity(myintent);
            }
        });
        ...
        btn_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(MainActivity.this, "회원가입을 선택하셨습니다.", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        btn_login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (setting.loginsuccess == true) {
                    Intent myintent = new Intent(MainActivity.this, lucidmain.class);
                    startActivity(myintent);
                    overridePendingTransition(R.anim.anim_slide_in_right, R.anim.anim_slide_out_left);
                    ...
                    startActivity(login);
                    overridePendingTransition(R.anim.anim_slide_in_right, R.anim.anim_slide_out_left);
                    Toast.makeText(MainActivity.this, "로그인을 선택하셨습니다.", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        btn_repeat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (repeat_playing == true) {
                    ...
                    Toast.makeText(MainActivity.this, "한곡 반복 비활성화", Toast.LENGTH_SHORT).show();
                } else {
                    mp.setLooping(true);
                    repeat_playing = true;
                    Toast.makeText(MainActivity.this, "한곡 반복 활성화", Toast.LENGTH_SHORT).show();
                }
        ...
        btn_repeat_all.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (repeat_playing_all == true) {
                    repeat_playing_all = false;
                    Toast.makeText(MainActivity.this, "전체 반복 비활성화", Toast.LENGTH_SHORT).show();
                } else {
                    repeat_playing_all = true;
                    Toast.makeText(MainActivity.this, "전체 반복 활성화", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        btn_repeat_random.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (repeat_playing_random == true) {
                    repeat_playing_random = false;
                    Toast.makeText(MainActivity.this, "임의 반복 비활성화", Toast.LENGTH_SHORT).show();
                } else {
                    repeat_playing_random = true;
                    Toast.makeText(MainActivity.this, "임의 반복 활성화", Toast.LENGTH_SHORT).show();
                }
            }
        });
...
//                            mp.pause();
    ...
    class song_change_Task extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            simpleWaitDialog = ProgressDialog.show(MainActivity.this, "잠시만 기다려주세요", "노래 변경중...");
        }
